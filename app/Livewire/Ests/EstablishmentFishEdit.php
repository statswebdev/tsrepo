...
class EstablishmentFishEdit extends Component
{
    ...
    protected $rules = [
            ...
            'skipjacktuna_inhouse_qty' => 'required|integer',
            'yellowfin_inhouse' => 'required',
            'yellowfin_inhouse_qty' => 'required|integer',
            'reeffish_inhouse' => 'required',
            'reeffish_inhouse_qty' => 'required|integer',
            'seafood_inhouse' => 'required',
            'seafood_inhouse_qty' => 'required|integer',
            'otherfish_inhouse' => 'nullable',
            'otherfish_inhouse_qty' => 'nullable|integer',
            'skipjack_purchased' => 'required',
            'skipjack_purchased_qty' => 'required|integer',
            'skipjack_purchased_value' => 'required|integer',
            'yellowfin_purchased' => 'required',
            'yellowfin_purchased_qty' => 'required|integer',
            'yellowfin_purchased_value' => 'required|integer',
            'reeffish_purchased' => 'required',
            'reeffish_purchased_qty' => 'required|integer',
            'reeffish_purchased_value' => 'required|integer',
            'seafood_purchased' => 'required',
            'seafood_purchased_qty' => 'required|integer',
            'seafood_purchased_value' => 'required|integer',
