...
class EstablishmentExpenses extends Component
{
    ...
    {
        $this->validate([
            'expense_salary' => 'required|numeric|max:99999999999999999999999999.99',
            'expense_allowance' => 'required|numeric|max:99999999999999999999999999.99',
            'expense_inkind' => 'required|numeric|max:99999999999999999999999999.99',
            'expense_salary_foreign' => 'required|numeric|max:99999999999999999999999999.99',
            'expense_allowance_foreign' => 'required|numeric|max:99999999999999999999999999.99',
            'expense_inkind_foreign' => 'required|numeric|max:99999999999999999999999999.99',
            'expense_food' => 'required|numeric|max:99999999999999999999999999.99',
            'expense_laundry' => 'required|numeric|max:99999999999999999999999999.99',
            'expense_transport' => 'required|numeric|max:99999999999999999999999999.99',
            'expense_water' => 'required|numeric|max:99999999999999999999999999.99',
            'expense_electricity' => 'required|numeric|max:99999999999999999999999999.99',
            'expense_fuel' => 'required|numeric|max:99999999999999999999999999.99',
            'expense_tele' => 'required|numeric|max:99999999999999999999999999.99',
            'expense_fines' => 'required|numeric|max:99999999999999999999999999.99',
            'expense_costofgoodssold' => 'required|numeric|max:99999999999999999999999999.99',
            'expense_lease' => 'required|numeric|max:99999999999999999999999999.99',
            'expense_depreciation' => 'required|numeric|max:99999999999999999999999999.99',
            'expense_financialcost' => 'required|numeric|max:99999999999999999999999999.99',
            'expense_marketing' => 'required|numeric|max:99999999999999999999999999.99',
            'expense_admin' => 'required|numeric|max:99999999999999999999999999.99',
            'expense_management' => 'required|numeric|max:99999999999999999999999999.99',
            'expense_other' => 'required|numeric|max:99999999999999999999999999.99',
        ]);
