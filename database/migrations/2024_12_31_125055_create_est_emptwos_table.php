...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('est_emptwos', function (Blueprint $table) {
            ...
            $table->integer('retailshop_male')->nullable();
            $table->integer('retailshop_female')->nullable();
            $table->string('divingcenter_outsourced');
            $table->integer('divingcenter_male')->nullable();
            $table->integer('divingcenter_female')->nullable();
            $table->string('restaurant_outsourced');
            $table->integer('restaurant_male')->nullable();
            $table->integer('restaurant_female')->nullable();
            $table->string('spa_outsourced');
            $table->integer('spa_male')->nullable();
            $table->integer('spa_female')->nullable();
            $table->string('transport_outsourced');
            $table->integer('transport_male')->nullable();
            $table->integer('transport_female')->nullable();
            $table->string('construction_outsourced');
            $table->integer('construction_male')->nullable();
            $table->integer('construction_female')->nullable();
