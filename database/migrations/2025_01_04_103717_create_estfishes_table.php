...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('estfishes', function (Blueprint $table) {
            ...
            $table->integer('skipjacktuna_inhouse_qty')->nullable();
            $table->string('yellowfin_inhouse');
            $table->integer('yellowfin_inhouse_qty')->nullable();
            $table->string('reeffish_inhouse');
            $table->integer('reeffish_inhouse_qty')->nullable();
            $table->string('seafood_inhouse');
            $table->integer('seafood_inhouse_qty')->nullable();
            $table->string('otherfish_inhouse')->nullable();
            $table->integer('otherfish_inhouse_qty')->nullable();
            $table->string('skipjack_purchased');
            $table->integer('skipjack_purchased_qty')->nullable();
            $table->integer('skipjack_purchased_value')->nullable();
            $table->string('yellowfin_purchased');
            $table->integer('yellowfin_purchased_qty')->nullable();
            $table->integer('yellowfin_purchased_value')->nullable();
            $table->string('reeffish_purchased');
            $table->integer('reeffish_purchased_qty')->nullable();
            $table->integer('reeffish_purchased_value')->nullable();
            $table->string('seafood_purchased');
            $table->integer('seafood_purchased_qty')->nullable();
            $table->integer('seafood_purchased_value')->nullable();
