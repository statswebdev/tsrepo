...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('estfuelconsums', function (Blueprint $table) {
            ...
            $table->integer('diesel_bought_year');
            $table->integer('petrol_bought_qty');
            $table->integer('petrol_bought_year');
            $table->integer('lpg_bought_qty');
            $table->integer('lpg_bought_year');
            $table->integer('other_bought_qty');
            $table->integer('other_bought_year');
            ...
            $table->string('other_inventory_specify');
            $table->string('other_inventory_unit');
            $table->integer('other_inventory_unit_yearfirst');
            $table->integer('other_inventory_unit_yearend');
            ...
            $table->string('diesel_other_fuelconsumption');
            $table->string('diesel_other_fuelconsumption_unit');
            $table->integer('diesel_other_fuelconsumption_qty');
            $table->string('petrol_other_fuelconsumption');
            $table->string('petrol_other_fuelconsumption_unit');
            $table->integer('petrol_other_fuelconsumption_qty');
            $table->string('status');
            $table->timestamps();
        });
    }
