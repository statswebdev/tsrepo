                      ...
                      <!-- Card -->
                        <div class="card mb-4">
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-sm-3">
                                    <input type="number" step="0.01" id="income_boarding" class="form-control" placeholder="MVR" wire:model="income_boarding">
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-sm-3">
                                    <input type="number" step="0.01" id="income_food" class="form-control" placeholder="MVR" wire:model="income_food">
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-sm-3">
                                    <input type="number" step="0.01" id="income_beverage" class="form-control" placeholder="MVR" wire:model="income_beverage">
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-sm-3">
                                    <input type="number" step="0.01" id="income_catering" class="form-control" placeholder="MVR" wire:model="income_catering">
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-sm-3">
                                    <input type="number" step="0.01" id="income_transport" class="form-control" placeholder="MVR" wire:model="income_transport">
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-sm-3">
                                    <input type="number" step="0.01" id="income_spa" class="form-control" placeholder="MVR" wire:model="income_spa">
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-sm-3">
                                    <input type="number" step="0.01" id="income_laundry" class="form-control" placeholder="MVR" wire:model="income_laundry">
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-sm-3">
                                    <input type="number" step="0.01" id="income_servicecharge" class="form-control" placeholder="MVR" wire:model="income_servicecharge">
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-sm-3">
                                    <input type="number" step="0.01" id="income_excursion" class="form-control" placeholder="MVR" wire:model="income_excursion">
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-sm-3">
                                    <input type="number" step="0.01" id="income_watersports" class="form-control" placeholder="MVR" wire:model="income_watersports">
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-sm-3">
                                    <input type="number" step="0.01" id="income_watersports_third" class="form-control" placeholder="MVR" wire:model="income_watersports_third">
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-sm-3">
                                    <input type="number" step="0.01" id="income_retailshop" class="form-control" placeholder="MVR" wire:model="income_retailshop">
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-sm-3">
                                    <input type="number" step="0.01" id="income_retailshop_third" class="form-control" placeholder="MVR" wire:model="income_retailshop_third">
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-sm-3">
                                    <input type="number" step="0.01" id="income_exchange" class="form-control" placeholder="MVR" wire:model="income_exchange">
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-sm-3">
                                    <input type="number" step="0.01" id="income_commission" class="form-control" placeholder="MVR" wire:model="income_commission">
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-sm-3">
                                    <input type="number" step="0.01" id="income_managementfee" class="form-control" placeholder="MVR" wire:model="income_managementfee">
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-sm-3">
                                    <input type="number" step="0.01" id="income_lease" class="form-control" placeholder="MVR" wire:model="income_lease">
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-sm-3">
                                    <input type="number" step="0.01" id="income_finance" class="form-control" placeholder="MVR" wire:model="income_finance">
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-sm-3">
                                    <input type="number" step="0.01" id="income_dividend" class="form-control" placeholder="MVR" wire:model="income_dividend">
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-sm-3">
                                    <input type="number" step="0.01" id="income_other" class="form-control" placeholder="MVR" wire:model="income_other">
