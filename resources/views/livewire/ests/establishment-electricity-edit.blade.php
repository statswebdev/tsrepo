    ...
    <section class="pt-6">
        <div class="container px-4 px-lg-0"> 
            <div class="row">
                ...
                <div class="col-md-6">
                    <!-- heading -->
                    <h1 class="display-4 fw-bold">Electricity</h1>
                    <p class="lead mb-0">Update electricity information for {{ $this->est_record_id->collectionyear }}.</p>
                </div>
            </div>    
        </div>
    </section>
                      ...
                      <!-- Card -->
                        <div class="card mb-4">
                            ...
                            <hr class="mt-5 mb-5">
                                ...
                                <h5>3. Electric Power Generation by sources (kWh)</h5>
