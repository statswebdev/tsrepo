    ...
    <section class="pt-6">
        <div class="container px-4 px-lg-0"> 
            <div class="row">
                ...
                <div class="col-md-6">
                    <!-- heading -->
                    <h1 class="display-4 fw-bold">Agricultural Production & Consumption</h1>
                    <p class="lead mb-0">Update agricultural production and consumption information for {{ $this->est_record_id->collectionyear }}.</p>
                </div>
            </div>    
        </div>
    </section>
