        ...
        <div class="container px-4 px-lg-0"> 
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <p class="lead mb-0">Update production and consumption information for {{ $this->est_record_id->collectionyear }}.</p>
                </div>
            </div>    
        </div>
    </section>
...
{{--
                            ...
                            <h5 class="mt-3">Waste Generated</h5>
                            <small class="mb-3">Monthly waste generated by type of waste (december)</small>

                            <div class="mb-3 col-12 col-md-12">
                                <label class="form-label" for="waste_monthly">Waste Monthly</label>
                                <input type="number" id="waste_monthly" class="form-control" placeholder="metric tones" wire:model="waste_monthly">
                            ...
                            <div class="mb-3 col-12 col-md-4">
                                ...
                                <input type="number" id="plastic_waste" class="form-control" placeholder="% by type" wire:model="plastic_waste">
                                @error('plastic_waste')<div class="invalid-feedback d-flex">{{ $message }}</div>@enderror
                            </div>


                            <div class="mb-3 col-12 col-md-8">
                                <label class="form-label" for="plastic_waste">Plastic Waste Method</label>
                                <div class="col-sm-12 text-center">
                                    @foreach(['Transported', 'Recycled', 'Incineration', 'Landfills', 'Composting', 'Other'] as $method)
                                        <label class="form-check form-check-inline">
                                            <input class="form-check-input" 
                                                   type="checkbox" 
                                                   value="{{ $method }}" 
                                                   name="plastic_waste_method[]" 
                                                   wire:model="plastic_waste_method">
                           ...
                           {{--  <div class="mb-3 col-12 col-md-6">
                            ...
                            <div class="mb-3 col-12 col-md-4">
                                ...
                                <input type="number" id="organic_waste" class="form-control" placeholder="% by type" wire:model="organic_waste">
                                    ...
                                    @foreach(['Transported', 'Recycled', 'Incineration', 'Landfills', 'Composting', 'Other'] as $method)
                                        <label class="form-check form-check-inline">
                                            <input class="form-check-input" 
                                                   type="checkbox" 
                                                   value="{{ $method }}" 
                                                   name="organic_waste_method[]" 
                                                   wire:model="organic_waste_method">
                                            <span class="form-check-label">{{ $method }}</span>
                                        </label>
                                    @endforeach
                                </div>
                           ...
                           {{--  <div class="mb-3 col-12 col-md-6">
                            ...
                            <div class="mb-3 col-12 col-md-4">
                                ...
                                <input type="number" id="metal_waste" class="form-control" placeholder="% by type" wire:model="metal_waste">
                                    ...
                                    @foreach(['Transported', 'Recycled', 'Incineration', 'Landfills', 'Composting', 'Other'] as $method)
                                        <label class="form-check form-check-inline">
                                            <input class="form-check-input" 
                                                   type="checkbox" 
                                                   value="{{ $method }}" 
                                                   name="metal_waste_method[]" 
                                                   wire:model="metal_waste_method">
                                            <span class="form-check-label">{{ $method }}</span>
                                        </label>
                                    @endforeach
                                </div>
                           ...
                           {{--  <div class="mb-3 col-12 col-md-6">
                            ...
                            <div class="mb-3 col-12 col-md-4">
                                ...
                                <input type="number" id="other_waste" class="form-control" placeholder="% by type" wire:model="other_waste">
                                    ...
                                    @foreach(['Transported', 'Recycled', 'Incineration', 'Landfills', 'Composting', 'Other'] as $method)
                                        <label class="form-check form-check-inline">
                                            <input class="form-check-input" 
                                                   type="checkbox" 
                                                   value="{{ $method }}" 
                                                   name="other_waste_method[]" 
                                                   wire:model="other_waste_method">
                                            <span class="form-check-label">{{ $method }}</span>
                                        </label>
                                    @endforeach
                                </div>
