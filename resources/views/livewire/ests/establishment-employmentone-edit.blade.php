    ...
    <section class="pt-6">
        <div class="container px-4 px-lg-0"> 
            <div class="row">
                ...
                <div class="col-md-6">
                    <!-- heading -->
                    <h1 class="display-4 fw-bold">Employment Part 1</h1>
                    <p class="lead mb-0">Update employment part 1 information for {{ $this->est_record_id->collectionyear }}.</p>
                </div>
            </div>    
        </div>
    </section>
                                ...
                                <div class="form-group row mb-4 ">
                                    ...
                                    @error('other_foreign_female')<div class="invalid-feedback d-flex">{{ $message }}</div>@enderror
                                               ...
                                               {{--  <div class="form-group row mt-4">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <input type="number" class="form-control fw-bold" value="{{ $this->totalMaldivianMale }}" readonly>
                                                    </div>
                                                    
                                                    <div class="col-sm-2">
                                                        <input type="number" class="form-control fw-bold" value="{{ $this->totalMaldivianFemale }}" readonly>
                                                    </div>
                                                    
                                                    <div class="col-sm-2">
                                                        <input type="number" class="form-control fw-bold" value="{{ $this->totalForeignMale }}" readonly>
                                                    </div>
