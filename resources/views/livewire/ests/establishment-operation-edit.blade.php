        ...
        <div class="container px-4 px-lg-0">
            <div class="row align-items-center">
                ...
                <div class="col-lg-8">
                    ...
                    <p class="lead mb-0">Update operating months, room and bed inventory, occupancy, and average room rate details.</p>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form wire:submit.prevent="save" class="row g-4">
                                ...
                                <div class="col-12">
                                    <fieldset>
                                        <legend class="form-label fs-6 fw-semibold mb-3">1. Months in operation during {{ $this->est_record_id->collectionyear }}</legend>
                                            ...
                                            @foreach(['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December', 'Not Operated', 'All the Months'] as $index => $month)
                                                <div class="col-6 col-md-4 col-lg-3">
                                                    <div class="form-check border rounded px-3 py-2 h-100">
                                                        <input type="checkbox" id="edit_months_operated_{{ $index + 1 }}"
                                                            class="form-check-input ms-0 me-2 @error('months_operated') is-invalid @enderror"
                                                            value="{{ $month }}" wire:model="months_operated">
                                                        <label class="form-check-label" for="edit_months_operated_{{ $index + 1 }}">{{ $month }}</label>
                                                    </div>
                                                </div>
                                            @endforeach
                                        </div>
                                ...
                                <div class="col-12">
                                    <div class="d-flex flex-column flex-sm-row justify-content-end gap-2 border-top pt-4 mt-2">
                                        <button type="submit" class="btn btn-primary" wire:loading.attr="disabled" wire:target="save">
                                            <span wire:loading.remove wire:target="save">Update operations</span>
